...
function searchActiveNotes(){
	window.open(basePath+"note/searchActiveNotes");
}
	...
	//======================================================================================
		...
		$('.panel_can').on('click','.panel_selectNote .sure',function(){
			...
			$.ajax({
				...
				async : false,
				dataType : "json",
				data: {"rowKey":noteRowKey,"activeRowKey":newNoteBookRowkey},
				success : function(data) {
					flag=data.success;
					if(flag){
						//AJAX
