	...
	<header class='clear_float'>
		...
		<div class="activity_btn">
			<div class="activity_link">
				<h4><input type="text" id="keyWords" /><a class="ac_link"  onclick="searchActiveNotesByKeyWords();">搜索活动笔记</a><i class='icon i_global'></i></h4>
			</div>
		</div>
	</header>
...
/* $(function(){
	...
	function searchActiveNotesByKeyWords(){
		var keyWords=$("#keyWords").val();
		$.ajax({
			type : "post",
			url : basePath +"note/searchActiveNotesByKeyWords",
			async : false,
			dataType : "json",
